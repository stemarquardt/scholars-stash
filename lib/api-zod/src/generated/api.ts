...
export const GetCurrentAuthUserResponse = zod.object({
  user: zod.union([
    zod.object({
      ...
      lastNameInitial: zod.string().nullish(),
...
export const ListLinksQueryParams = zod.object({
  ...
  sortBy: zod.enum(["newest", "oldest", "most_reactions", "title"]).optional(),
});

export const ListLinksResponseItem = zod
  .object({
    id: zod.number(),
    url: zod.string(),
    title: zod.string(),
...
export const GetLinkResponse = zod
  .object({
    id: zod.number(),
    url: zod.string(),
    title: zod.string(),
...
export const UpdateLinkResponse = zod
  .object({
    id: zod.number(),
    url: zod.string(),
    title: zod.string(),
